...
class Pirate_Switch_General_Repeater extends WP_Customize_Control {
	...
	public function enqueue() {
        ...
        wp_enqueue_style( 'customizer-repeater-admin-stylesheet_ps', plugin_dir_url( __DIR__ ) . 'css/style.css',PIRATE_SWITCH_VERSION );

		wp_enqueue_style( 'wp-color-picker' );

		wp_enqueue_script( 'customizer-repeater-script-ps', plugin_dir_url( __DIR__ ) . 'js/customizer_repeater_ps.js', array('jquery', 'jquery-ui-draggable', 'wp-color-picker' ), PIRATE_SWITCH_VERSION, true  );
